    ...
    <div className={styles.container}>
      <div className={styles.header}>
        <button className={styles["icon-button"]}>
          <img src={ArrowBackWhiteIcon} alt="Back" />
        </button>
        {car?.vhclRegNo}
      </div>
        ...
        <div className={styles.content}>
          ...
          <ContentBox title="옵션 정보">
            ...
            <p className={`${styles["option-description"]} font-r-xs`}>
              탈부착이 가능한 옵션 품목은 중고차 특성상, 이전 차주의 반납 여부와
              사용감에 따라 제공되지 않을 수 있습니다.
            </p>
          </ContentBox>
          <ContentBox title="할부 계산기">
            ...
            <p className={`${styles["option-description"]} font-r-xs`}>
              본인인증을 통해 고객님의 실제 개인 할부 한도를 조회하고 적용해 볼
              수 있습니다.
            </p>
            <p className={`${styles["option-description"]} font-r-xs`}>
              조회 프로세스를 완료하면 위 할부 계산기에서 고객님의 실제 예상 월
              납입금액을 확인하실 수 있습니다.
            </p>
          </ContentBox>
